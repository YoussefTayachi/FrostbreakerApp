...
class TestClassifyError:
    ...
    def test_429_nur_als_eigenstaendige_zahl(self):
        """Eine Vorgangsnummer, in der zufaellig '429' steckt, ist keine Drosselung.

        Der frueher hier stehende blanke Teilstring '429' haette in einer
        Kennung wie 'req_011CS429abc' getroffen und einen gewoehnlichen Fehler
...
class TestProviderFromError:
    ...
    def test_personalize_laeuft_ueber_openai(self):
        """Der Regelfall (SDK-Fehler ohne URL) darf seinen Alarm nicht verlieren."""
        assert provider_from_error(OPENAI_NO_CREDITS, "personalize") == "openai"
