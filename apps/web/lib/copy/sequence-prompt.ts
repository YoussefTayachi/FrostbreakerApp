...
export function buildSequencePrompt(
  ...
  lines.push(
    ...
    // Am 2026-09-01 nach Mentor-Feedback verschaerft: die alte Zeile bot als
    // Ersatz "observable behaviour" an ("people arrive, hesitate, and leave"),
    // und genau solche Saetze standen dann in echten Sequenzen ("someone looks
    // you up and moves on to the next name"). Niemand hat das beobachtet, also
    // wird es nicht geschrieben.
    "- Never invent a consequence or a scene either. No claims about what readers or visitors",
    "  will think, feel or do ('less trustworthy', 'people move on'), and no imagined scene",
    "  nobody observed. If the offer's material states no honest consequence, restate the",
    "  offer and its terms instead.",
    "",
    ...
    "  one line that anchors back to the first mail. Never 'just checking in' and never",
    "  a claim to be human ('real person here' reads as automated, ironically).",
    "  then the offer restated in one sentence. Same friction, same page, same next step.",
    "  the micro yes, word for word.",
    "",
    "STEP 3 (day 5) -- the summary",
    "  a short context line, then the smallest true version of the deal: what you send,",
    "  what it costs them, how long it takes to look at.",
