...
const de: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Apollo.io — Massensuche: Firma und Entscheider samt verifizierter E-Mail in einem Schritt. Braucht mindestens Apollos Basic-Plan.",
...
const en: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Apollo.io — bulk search: company and decision maker with a verified email in one step. Needs at least Apollo's Basic plan.",
