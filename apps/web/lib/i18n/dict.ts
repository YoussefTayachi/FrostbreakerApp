...
const de = {
  ...
  settings: {
    ...
    providerHints: {
      ...
      apollo: "Für die Apollo-Massensuche (Firma + Entscheider + verifizierte E-Mail in einem Schritt). Master-API-Key, bei Apollo erst ab dem Organization-Plan enthalten.",
...
const en: Dictionary = {
  ...
  settings: {
    ...
    providerHints: {
      ...
      apollo: "For Apollo bulk search (company + decision maker + verified email in one step). Master API key, only included from Apollo's Organization plan.",
