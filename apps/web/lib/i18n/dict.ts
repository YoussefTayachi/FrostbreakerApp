...
const de = {
  ...
  wiederkontakt: {
    title: "Wiederkontakt",
    subtitle: "Wer abwesend war, bekommt nach der Rückkehr noch einmal Post. Eine Liste je Woche und Absender.",
    empty: "Niemand wartet. Abwesenheitsnotizen landen hier automatisch.",
    week: (kw: number, von: string) => `KW ${kw} · ab ${von}`,
    thisWeek: "diese Woche",
    contacts: (n: number) => (n === 1 ? "1 Kontakt" : `${n} Kontakte`),
    estimated: "geschätzt",
    estimatedTitle: "Die Notiz nannte kein Datum: zwei Wochen ab Eingang angenommen.",
    back: "zurück am",
    window: (w: string, r: string) => `sendet ${w} ${r === "UK" ? "London" : "New York"}`,
    windowTitle: "Sendefenster nach Herkunft: UK am britischen Vormittag, US im New Yorker Arbeitstag.",
    sender: { berat: "Berat", ramy: "Ramy" } as Record<string, string>,
    create: "Kampagne anlegen",
    creating: "Lege an…",
    created: (name: string, n: number) => `${name} angelegt, ${n} Kontakte kopiert. Starten unter Instantly › Kampagnen.`,
    existed: (name: string) => `${name} gibt es schon.`,
    error: (grund: string) => `Anlegen fehlgeschlagen: ${grund}`,
    openCampaign: "Zur Kampagne",
    fromCampaign: "aus",
    noEmail: "ohne Adresse",
    waitingTotal: (n: number) => (n === 1 ? "1 Kontakt wartet" : `${n} Kontakte warten`),
    howTitle: "So läuft es",
    how: [
      "Jede Abwesenheitsnotiz setzt den Kontakt auf „Abwesend“ und merkt sich das Rückkehrdatum.",
      "Jeden Montag legt Frostbreaker die Liste der Woche als Entwurf an, je Absender eine.",
      "Anlegen kopiert die Kontakte in eine eigene Liste; die Originale behalten ihre Historie.",
      "Gestartet wird wie jede Kampagne unter Instantly › Kampagnen.",
    ],
  },
  nav: {
  ...
  leads: {
    ...
    statusLabels: {
      new: "Neu", contacted: "Kontaktiert", out_of_office: "Abwesend", replied: "Geantwortet", lead: "Lead",
  ...
  inbox: {
    ...
    filterCommission: "Meine Kampagne",
  ...
  settings: {
    ...
    sections: {
      ...
      "/settings/mcp": {
        title: "Claude-Zugang",
        hint: "Leads, Angebot und Kampagnenzahlen lesen, Icebreaker schreiben: mit deinem eigenen Claude.",
      },
      "/blocklist": {
        title: "Sperrliste",
    ...
    sentSync: {
      heading: "Gesendetes mitlesen",
      loading: "Lade…",
      description:
        "Instantly synchronisiert nur eingehende Mails. Was du über Webmail oder dein Handy schreibst, sieht es nie. Verbinde das Postfach hier, dann liest Frostbreaker den Gesendet-Ordner selbst und dein Verlauf ist vollständig.",
      empty: "Noch kein Postfach verbunden.",
      add: "Postfach verbinden",
      cancel: "Abbrechen",
      save: "Verbinden und prüfen",
      saving: "Prüfe Zugang…",
      remove: "Trennen",
      removing: "Trenne…",
      ...
      userHint: "Leer lassen, wenn er der E-Mail-Adresse entspricht.",
      passwordLabel: "Passwort",
      folderLabel: "Gesendet-Ordner",
      folderHint: "Leer lassen, dann wird er beim Verbinden erkannt.",
      connected: (ordner: string) => `Verbunden. Gelesen wird der Ordner „${ordner}".`,
      connectedUnknown: "Verbunden.",
      lastSync: (wann: string) => `zuletzt gelesen ${wann}`,
      neverSynced: "noch nicht gelesen",
      onlyKnownContacts:
        "Übernommen werden nur Mails an Kontakte aus diesem Workspace. Privates bleibt draußen.",
      removeConfirm:
        "Zugangsdaten trennen? Die bereits übernommenen Mails bleiben im Verlauf stehen.",
    },
    mailboxes: {
    ...
    mcp: {
      ...
      workspaceHint: "Die Einschränkung auf einen Workspace gibt nie mehr Rechte, als deine Mitgliedschaft dort ohnehin erlaubt.",
      expiryLabel: "Gültigkeit",
      expiryNever: "Läuft nicht ab",
      expiry30: "30 Tage",
      expiry90: "90 Tage",
      expiry365: "365 Tage",
      tokenOnceTitle: "Dieser Token wird nur jetzt angezeigt",
      tokenOnceBody:
        "Kopiere ihn jetzt an seinen Bestimmungsort. Frostbreaker speichert nur einen Hash davon, danach lässt sich der Token nirgendwo mehr einsehen, auch nicht im Support.",
      copyButton: "Kopieren",
      copiedOk: "Kopiert",
      doneButton: "Fertig",
      ...
      revokeConfirm: (name: string) => `Token "${name}" widerrufen? Verbundene Claude-Instanzen verlieren sofort den Zugriff.`,
      revokedOk: "Widerrufen",
      errNameRequired: "Gib dem Token einen Namen.",
      errCreateFailed: "Der Token konnte nicht erzeugt werden. Der Server hat nicht geantwortet oder einen Fehler gemeldet. Versuch es gleich noch einmal.",
      errRevokeFailed: "Der Token konnte nicht widerrufen werden. Der Server hat nicht geantwortet oder einen Fehler gemeldet. Versuch es gleich noch einmal.",
    },
  },
  instantly: {
    subnav: {
    ...
    campaigns: {
      ...
      form: {
        ...
        variableSnippet: {
          subjectLine: "Betreff (Person)",
          opener: "Eröffnungssatz",
          platformWhereIGotIt: "Plattform",
          whatTheySaid: "Was die Person sagte",
          segments: "Käufergruppen",
          promise: "Versprechen",
          ctaTail: "Bitte (Ende)",
        } as Record<string, string>,
  ...
  commission: {
    title: "Provision",
    subtitle:
      "Welche Antworten auf deine eigene Kampagne gingen, wenn aus einem fremden Instantly-Konto gesendet wird. Gezählt aus den synchronisierten Mails, nicht aus Instantlys Rollup.",
    emptyTitle: "Noch keine eigene Kampagne markiert.",
    emptyHint:
      "Jede Kampagne, die du in Frostbreaker veröffentlichst, wird beim Veröffentlichen automatisch als deine markiert. Danach steht sie hier und im Posteingang unter dem Reiter „Meine Kampagne“.",
    allMonths: "Alle Monate",
    campaign: "Kampagne",
    contacted: "Angeschrieben",
    replied: "Geantwortet",
    human: "Menschen",
    humanHint: "ohne Abwesenheitsnotizen",
    positive: "Interessiert oder Rückfrage",
    noneInMonth: "In diesem Monat lief keine deiner Kampagnen.",
    repliesTitle: (n: number) => (n === 1 ? "1 Antwort" : `${n} Antworten`),
    repliesHint: "je Adresse die erste Antwort",
    contact: "Kontakt",
    interest: "Einstufung",
    date: "Datum",
...
const en: Dictionary = {
  ...
  wiederkontakt: {
    title: "Re-engage",
    subtitle: "Whoever was out of office gets one more email after they return. One list per week and sender.",
    empty: "Nobody is waiting. Out-of-office replies land here automatically.",
    week: (kw: number, von: string) => `Week ${kw} · from ${von}`,
    thisWeek: "this week",
    contacts: (n: number) => (n === 1 ? "1 contact" : `${n} contacts`),
    estimated: "estimated",
    estimatedTitle: "The notice named no date: two weeks after arrival assumed.",
    back: "back on",
    window: (w: string, r: string) => `sends ${w.replace(" bis ", " to ")} ${r === "UK" ? "London" : "New York"} time`,
    windowTitle: "Send window by origin: UK in the British morning, US in the New York workday.",
    sender: { berat: "Berat", ramy: "Ramy" } as Record<string, string>,
    create: "Create campaign",
    creating: "Creating…",
    created: (name: string, n: number) => `${name} created, ${n} contacts copied. Start it under Instantly › Campaigns.`,
    existed: (name: string) => `${name} already exists.`,
    error: (grund: string) => `Creating failed: ${grund}`,
    openCampaign: "Open campaign",
    fromCampaign: "from",
    noEmail: "no address",
    waitingTotal: (n: number) => (n === 1 ? "1 contact waiting" : `${n} contacts waiting`),
    howTitle: "How it works",
    how: [
      "Every out-of-office reply sets the contact to “Out of office” and stores the return date.",
      "Every Monday Frostbreaker creates the week's list as a draft, one per sender.",
      "Creating copies the contacts into their own list; the originals keep their history.",
      "Start it like any campaign under Instantly › Campaigns.",
    ],
  },
  nav: {
  ...
  leads: {
    ...
    statusLabels: {
      new: "New", contacted: "Contacted", out_of_office: "Out of office", replied: "Replied", lead: "Lead",
  ...
  settings: {
    ...
    sections: {
      ...
      "/settings/mcp": {
        title: "Claude access",
        hint: "Read leads, offer and campaign numbers, write icebreakers: with your own Claude.",
      },
      "/blocklist": {
        title: "Blocklist",
    ...
    sentSync: {
      heading: "Read your sent mail",
      loading: "Loading…",
      description:
        "Instantly only syncs incoming mail. Whatever you write from webmail or your phone, it never sees. Connect the mailbox here and Frostbreaker reads the sent folder itself, so your history is complete.",
      empty: "No mailbox connected yet.",
      add: "Connect mailbox",
      cancel: "Cancel",
      save: "Connect and verify",
      saving: "Checking access…",
      remove: "Disconnect",
      ...
      portLabel: "Port",
      userLabel: "Username",
      userHint: "Leave empty if it matches the email address.",
      passwordLabel: "Password",
      folderLabel: "Sent folder",
      folderHint: "Leave empty to detect it on connect.",
      connected: (ordner: string) => `Connected. Reading the folder "${ordner}".`,
      connectedUnknown: "Connected.",
      lastSync: (wann: string) => `last read ${wann}`,
      neverSynced: "not read yet",
      onlyKnownContacts:
        "Only mail to contacts in this workspace is imported. Personal mail stays out.",
      removeConfirm: "Disconnect these credentials? Mail already imported stays in the history.",
    },
    mailboxes: {
    ...
    mcp: {
      ...
      workspaceHint: "Limiting a token to one workspace never grants more than your membership there already allows.",
      expiryLabel: "Expires",
      expiryNever: "Never expires",
      expiry30: "30 days",
      expiry90: "90 days",
      expiry365: "365 days",
      tokenOnceTitle: "This token is shown once",
      tokenOnceBody:
        "Copy it now to wherever it needs to go. Frostbreaker stores only a hash of it, so the token can't be retrieved again afterward, not even by support.",
      copyButton: "Copy",
      copiedOk: "Copied",
      doneButton: "Done",
      ...
      revokeButton: "Revoke",
      revokeConfirm: (name: string) => `Revoke token "${name}"? Connected Claude instances lose access immediately.`,
      revokedOk: "Revoked",
      errNameRequired: "Give the token a name.",
      errCreateFailed: "The token could not be created. The server didn't respond or returned an error. Try again in a moment.",
      errRevokeFailed: "The token could not be revoked. The server didn't respond or returned an error. Try again in a moment.",
    },
  },
  instantly: {
    subnav: {
    ...
    campaigns: {
      ...
      form: {
        ...
        variableSnippet: {
          subjectLine: "Subject (person)",
          opener: "Opening sentence",
          platformWhereIGotIt: "Platform",
          whatTheySaid: "What they said",
          segments: "Buyer groups",
          promise: "Promise",
          ctaTail: "Ask (ending)",
        } as Record<string, string>,
  ...
  commission: {
    title: "Commission",
    subtitle:
      "Which replies came from your own campaign when you send from someone else's Instantly account. Counted from the synced emails, not from Instantly's rollup.",
    emptyTitle: "No campaign of yours marked yet.",
    emptyHint:
      "Every campaign you publish from Frostbreaker is marked as yours at publish time. After that it shows up here and in the inbox under the “My campaign” tab.",
    allMonths: "All months",
    campaign: "Campaign",
    contacted: "Contacted",
    replied: "Replied",
    human: "Humans",
    humanHint: "auto replies excluded",
    positive: "Interested or question",
    noneInMonth: "None of your campaigns ran in this month.",
    repliesTitle: (n: number) => (n === 1 ? "1 reply" : `${n} replies`),
    repliesHint: "first reply per address",
    contact: "Contact",
