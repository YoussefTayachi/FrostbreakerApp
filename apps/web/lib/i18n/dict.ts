...
const de = {
  ...
  linkedin: {
    ...
    summary: (total: number, ready: number, withoutEmail: number) =>
      `${total} Profile · ${ready} mit fertigem Icebreaker · ${withoutEmail} nur über LinkedIn erreichbar`,
    filterOnlyWithoutEmail: "Nur ohne E-Mail-Adresse",
    filterHideContacted: "Bereits angeschriebene ausblenden",
    truncated: (shown: number, total: number) =>
      `Es werden ${shown} von ${total} Profilen angezeigt. Arbeite die Liste ab oder grenze sie ein, der Rest erscheint danach.`,
    templateShow: "Vorlage bearbeiten",
    templateHide: "Vorlage zuklappen",
    templateHeading: "Nachrichtenvorlage",
    templateHint:
      "Platzhalter: {{firstName}}, {{companyName}}, {{personalization}} — dieselben Namen wie in den E-Mail-Kampagnen. Fehlt der Icebreaker, verschwindet sein Absatz spurlos.",
    templateSave: "Vorlage speichern",
    templateSaved: "Vorlage gespeichert",
    templateReset: "Auf Standard zurücksetzen",
    templateIsDefault: "Aktuell gilt die Standardvorlage.",
    templateUnknownPlaceholders: (names: string) =>
      `Unbekannte Platzhalter, die so wörtlich beim Empfänger landen: ${names}`,
...
const en: Dictionary = {
  ...
  linkedin: {
    ...
    summary: (total: number, ready: number, withoutEmail: number) =>
      `${total} profiles · ${ready} with a ready icebreaker · ${withoutEmail} reachable only via LinkedIn`,
    filterOnlyWithoutEmail: "Only without an email address",
    filterHideContacted: "Hide already contacted",
    truncated: (shown: number, total: number) =>
      `Showing ${shown} of ${total} profiles. Work through the list or narrow it down, the rest appears afterwards.`,
    templateShow: "Edit template",
    templateHide: "Collapse template",
    templateHeading: "Message template",
    templateHint:
      "Placeholders: {{firstName}}, {{companyName}}, {{personalization}} — the same names as in the email campaigns. If the icebreaker is missing, its paragraph disappears cleanly.",
    templateSave: "Save template",
    templateSaved: "Template saved",
    templateReset: "Reset to default",
    templateIsDefault: "Currently using the default template.",
    templateUnknownPlaceholders: (names: string) =>
      `Unknown placeholders that would reach the recipient verbatim: ${names}`,
